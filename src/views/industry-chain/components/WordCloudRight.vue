<template>
    <div class="wordCloud__tagBall__right" :style="{width:`${this.width}px`,height:`${this.height}px`}">
        <span
...
<style lang="scss" scoped>
    .wordCloud__tagBall__right {
        ...
        .wordCloud__tag {
            ...
            padding-left: 15px;
            background: url('~@/assets/images/trade/icon3.png') no-repeat left center/ 16px 16px;
